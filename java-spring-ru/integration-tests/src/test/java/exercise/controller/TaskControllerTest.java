...
class ApplicationTest {
    ...
    public void testCreate() throws Exception {
        ...
        assertThat(newTask.getCreatedAt()).isEqualTo(task.getCreatedAt());
        assertThat(newTask.getDescription()).isEqualTo(task.getDescription());
        assertThat(newTask.getTitle()).isEqualTo(task.getTitle());
        assertThat(newTask.getUpdatedAt()).isEqualTo(task.getUpdatedAt());
    }
    ...
    public void testUpdate() throws Exception {
        ...
        assertThat(actualTask.getCreatedAt()).isEqualTo(task.getCreatedAt());
        assertThat(actualTask.getDescription()).isEqualTo(task.getDescription());
        assertThat(actualTask.getTitle()).isEqualTo(task.getTitle());
        assertThat(actualTask.getUpdatedAt()).isEqualTo(task.getUpdatedAt());
    }
